 ...
 */
 ...
 /*
 *  This file is a modified version of sha4.c, which is licensed under the GNU General Public License(GPL) version 2.
 ...
 */
void sha4_update( sha4_context *ctx, const unsigned char *input, uint64_t ilen )
{
    uint64_t fill;
    uint64_t left;
 ...
 */
void sha4( const void* input, uint64_t ilen,
           unsigned char output[64])
{
    sha4_context ctx;

    sha4_starts( &ctx );
    sha4_update( &ctx, (const unsigned char*) input, ilen );

...
#define FUZZY_FLAG_NOTRUNC 0x2u
     ...
     */
    extern int fuzzy_update(struct fuzzy_state* state, const unsigned char* buffer, uint64_t buffer_size);
     ...
     */
    extern int fuzzy_hash_buf(const unsigned char* buf, uint64_t buf_len, /*@out@*/ char* result);
